package com.dartgod.flutter_bluetooth_flow.bluetooth.plugin

import android.content.Context
import android.os.Handler
import android.os.Looper
import androidx.lifecycle.MutableLiveData
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.BluetoothSetup
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.connect.ClientBtConnector
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.connect.PluginClientBtConnector
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.find_service.BtFindService
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.find_service.PluginBluetoothFindService
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.find_service.ScanModeListener
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.find_service.ScannerListener
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.send_data.BluetoothTransceiver
import com.dartgod.flutter_bluetooth_flow.bluetooth.data.modules.send_data.PluginBluetoothTransceiver
import com.dartgod.flutter_bluetooth_flow.bluetooth.domain.PDevice
import com.dartgod.flutter_bluetooth_flow.bluetooth.tools.MESSAGE_READ
